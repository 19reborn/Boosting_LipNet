...
from src.relaxed_layers import (RelaxedConv2d, RelaxedNorm, RelaxedBatchNorm2d, RelaxedBatchNorm1d, RelaxedReLU, RelaxedAvgPool2d, RelaxedFlatten, RelaxedLinear,
    RelaxedBias, RelaxedScale, RelaxedEntropy, RelaxedGlobalAvgPool2d, RelaxedUpsample)
from src.zonotope import clamp_image, HybridZonotope
from src.utils import my_cauchy
import sys
...
class CombinedNetwork(nn.Module):
    ...
    def get_abs_loss(self, inputs, targets, eps, domain, threshold_min, beta=None):
        if domain in ["zono", "box", 'zono_iter', 'hbox']:
            ...
            if domain in ["box","hbox"] and self.net.n_class != None and self.net.n_class > 1:
